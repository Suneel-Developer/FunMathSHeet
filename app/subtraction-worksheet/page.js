...
const SubtractionWorksheet = () => {
    ...
    const generateProblems = (level) => {
        ...
        for (let i = 0; i < 45; i++) {
            ...
            newProblems.push(`${larger} - ${smaller} =`);
            newAnswers.push(larger - smaller);
        }
    ...
    const downloadPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text('Subtraction Worksheet', 105, 10, null, null, 'center');
            ...
            <div className="px-1 xsm:px-3 flex flex-col items-center justify-center mb-8">
                <div className="w-full max-w-[901px] mx-auto">
                    <header className="flex justify-center items-center pt-8 pb-12 w-full">
                        <h1 className="text-xl xsm:text-2xl font-extrabold text-center">Subtraction Worksheet</h1>
                    </header>
