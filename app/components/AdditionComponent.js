...
const AdditionComponent = () => {
    ...
    const downloadPDF = () => {
        ...
        doc.setFontSize(18);
        doc.text('Addition Worksheet', 105, 10, null, null, 'center');
        ...
        const footerColor = '#008000'; // Green color
            ...
            <div className="px-1 xsm:px-3 flex flex-col items-center justify-center mb-8">
                <div className="w-full max-w-[901px] mx-auto">
                    <header className="flex justify-center items-center pt-8 pb-12 w-full">
                        <h1 className="text-xl xsm:text-2xl font-extrabold text-center">Addition Worksheet</h1>
                    </header>
